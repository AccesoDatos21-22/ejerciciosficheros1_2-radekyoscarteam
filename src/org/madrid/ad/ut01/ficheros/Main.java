...
public class Main {
	...
	public static void main(String[] args) {
		...
		String ruta = "src/org/madrid/ad/ut01/ficheros/assets/el_quijote.txt";
			...
			ejercicios.palabraMasLarga(ruta);
			...
			ejercicios.frecuenciaVocales(ruta);
//			ejercicios.frecuenciaVocales(ruta).forEach((k,v)->System.out.println("Vocal: "+k+", valor: "+ v));

			System.out.println("\nFrecuencia de Letras: \n");
			ejercicios.frecuenciaLetras(ruta);
//			ejercicios.frecuenciaLetrasConHashMap(ruta).forEach((k,v)->System.out.println("Letra: "+k+", valor: "+ v));
